SRC = so_long.c file_to_img.c map_printer.c map_array.c GNL/get_next_line.c GNL/get_next_line_utils.c free.c errors.c checks.c end_screen.c key_hook.c movements.c
OBJ = $(SRC:.c=.o)
NAME = so_long
CC = gcc
